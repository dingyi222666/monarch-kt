...
public val WgslLanguage: IMonarchLanguage = buildMonarchLanguage {
  tokenPostfix = ".wgsl"
  unicode = true
  ...
  "reserved" and listOf("NULL", "Self", "abstract", "active", "alignas", "alignof", "as", "asm",
      ...
      "compile", "compile_fragment", "concept", "const_cast", "consteval", "constexpr", "constinit",
      "crate", "debugger", "decltype", "delete", "demote", "demote_to_helper", "do", "dynamic_cast",
  ...
  "predeclared_enums" and listOf("read", "write", "read_write", "function", "private", "workgroup",
      "uniform", "storage", "perspective", "linear", "flat", "center", "centroid", "sample",
      ...
      "rg32uint", "rg32sint", "rg32float", "rgba32uint", "rgba32sint", "rgba32float", "bgra8unorm")
  ...
  "predeclared_type_generators" and listOf("array", "atomic", "mat2x2", "mat2x3", "mat2x4",
      "mat3x2", "mat3x3", "mat3x4", "mat4x2", "mat4x3", "mat4x4", "ptr", "texture_1d", "texture_2d",
  ...
  "predeclared_intrinsics" and listOf("bitcast", "all", "any", "select", "arrayLength", "abs",
      ...
      "firstTrailingBit", "floor", "fma", "fract", "frexp", "inverseBits", "inverseSqrt", "ldexp",
      ...
      "smoothstep", "sqrt", "step", "tan", "tanh", "transpose", "trunc", "dpdx", "dpdxCoarse",
      ...
      "textureSampleLevel", "textureSampleBaseClampToEdge", "textureStore", "atomicLoad",
      "atomicStore", "atomicAdd", "atomicSub", "atomicMax", "atomicMin", "atomicAnd", "atomicOr",
      "atomicXor", "atomicExchange", "atomicCompareExchangeWeak", "pack4x8snorm", "pack4x8unorm",
