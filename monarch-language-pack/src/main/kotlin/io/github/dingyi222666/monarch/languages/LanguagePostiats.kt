...
public val PostiatsLanguage: IMonarchLanguage by lazy {
  buildMonarchLanguage {
    ...
    "irregular_keyword_list" and listOf("val+", "val-", "val", "case+", "case-", "case", "addr@",
        ...
        "view", "type+", "type-", "type", "vtype+", "vtype-", "vtype", "vt@ype+", "vt@ype-",
        "vt@ype", "viewt@ype+", "viewt@ype-", "viewt@ype", "viewtype+", "viewtype-", "viewtype",
        "prop+", "prop-", "prop", "type+", "type-", "type", "t@ype", "t@ype+", "t@ype-", "abst@ype",
        "abstype", "absviewt@ype", "absvt@ype", "for*", "for", "while*", "while")
