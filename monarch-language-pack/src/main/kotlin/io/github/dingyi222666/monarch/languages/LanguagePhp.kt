...
public val PhpLanguage: IMonarchLanguage = buildMonarchLanguage {
  tokenPostfix = ""
  defaultToken = ""
  "phpKeywords" and listOf("abstract", "and", "array", "as", "break", "callable", "case", "catch",
      ...
      "interface", "instanceof", "insteadof", "namespace", "new", "null", "object", "old_function",
      "or", "private", "protected", "public", "resource", "static", "switch", "throw", "trait",
      "try", "true", "use", "var", "while", "xor", "die", "echo", "empty", "exit", "eval",
