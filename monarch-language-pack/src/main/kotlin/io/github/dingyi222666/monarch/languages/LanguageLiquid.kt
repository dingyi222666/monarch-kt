...
public val LiquidLanguage: IMonarchLanguage = buildMonarchLanguage {
  tokenPostfix = ""
  defaultToken = ""
  ...
  "builtinFilters" and listOf("abs", "append", "at_least", "at_most", "capitalize", "ceil",
      ...
      "floor", "join", "json", "last", "lstrip", "map", "minus", "modulo", "newline_to_br", "plus",
      "prepend", "remove", "remove_first", "replace", "replace_first", "reverse", "round", "rstrip",
      "size", "slice", "sort", "sort_natural", "split", "strip", "strip_html", "strip_newlines",
      "times", "truncate", "truncatewords", "uniq", "upcase", "url_decode", "url_encode", "where")
