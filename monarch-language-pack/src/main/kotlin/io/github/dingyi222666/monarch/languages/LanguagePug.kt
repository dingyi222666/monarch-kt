...
public val PugLanguage: IMonarchLanguage = buildMonarchLanguage {
  tokenPostfix = ".pug"
  ignoreCase = true
  defaultToken = ""
  brackets {
  ...
  keywords("append", "block", "case", "default", "doctype", "each", "else", "extends", "for", "if",
      "in", "include", "mixin", "typeof", "unless", "var", "when")
  "tags" and listOf("a", "abbr", "acronym", "address", "area", "article", "aside", "audio", "b",
      ...
      "dfn", "div", "dl", "dt", "em", "embed", "fieldset", "figcaption", "figure", "font", "footer",
      "form", "frame", "frameset", "h1", "h2", "h3", "h4", "h5", "h6", "head", "header", "hgroup",
      "hr", "html", "i", "iframe", "img", "input", "ins", "keygen", "kbd", "label", "li", "link",
      ...
      "title", "tr", "tracks", "tt", "u", "ul", "video", "wbr")
  symbols("[\\+\\-\\*\\%\\&\\|\\!\\=\\/\\.\\,\\:]+")
