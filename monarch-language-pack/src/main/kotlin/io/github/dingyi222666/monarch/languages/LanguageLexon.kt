...
public val LexonLanguage: IMonarchLanguage = buildMonarchLanguage {
  tokenPostfix = ".lexon"
  ignoreCase = true
  keywords("lexon", "lex", "clause", "terms", "contracts", "may", "pay", "pays", "appoints", "into",
      "to")
  typeKeywords("amount", "person", "key", "time", "date", "asset", "text")
  operators("less", "greater", "equal", "le", "gt", "or", "and", "add", "added", "subtract",
      "subtracted", "multiply", "multiplied", "times", "divide", "divided", "is", "be", "certified")
  symbols("[=><!~?:&|+\\-*\\/\\^%]+")
  tokenizer {
    root {
