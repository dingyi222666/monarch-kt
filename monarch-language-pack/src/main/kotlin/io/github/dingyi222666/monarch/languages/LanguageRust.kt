...
public val RustLanguage: IMonarchLanguage = buildMonarchLanguage {
  tokenPostfix = ".rust"
  ...
  typeKeywords("Self", "m32", "m64", "m128", "f80", "f16", "f128", "int", "uint", "float", "char",
      ...
      "c_schar", "c_uchar", "c_short", "c_ushort", "c_int", "c_uint", "c_long", "c_ulong", "size_t",
      "ptrdiff_t", "clock_t", "time_t", "c_longlong", "c_ulonglong", "intptr_t", "uintptr_t",
      "off_t", "dev_t", "ino_t", "pid_t", "mode_t", "ssize_t")
