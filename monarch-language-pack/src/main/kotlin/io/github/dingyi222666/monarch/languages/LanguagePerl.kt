...
public val PerlLanguage: IMonarchLanguage = buildMonarchLanguage {
  tokenPostfix = ".perl"
  defaultToken = ""
  brackets {
  ...
  keywords("__DATA__", "else", "lock", "__END__", "elsif", "lt", "__FILE__", "eq", "__LINE__",
      "exp", "ne", "sub", "__PACKAGE__", "for", "no", "and", "foreach", "or", "unless", "cmp", "ge",
      "package", "until", "continue", "gt", "while", "CORE", "if", "xor", "do", "le", "__DIE__",
      "__WARN__")
  "builtinFunctions" and listOf("-A", "END", "length", "setpgrp", "-B", "endgrent", "link",
      ...
      "pop", "state", "-X", "gethostent", "pos", "study", "-x", "getlogin", "print", "substr", "-z",
      "getnetbyaddr", "printf", "symlink", "abs", "getnetbyname", "prototype", "syscall", "accept",
      "getnetent", "push", "sysopen", "alarm", "getpeername", "quotemeta", "sysread", "atan2",
      "getpgrp", "rand", "sysseek", "AUTOLOAD", "getppid", "read", "system", "BEGIN", "getpriority",
      "readdir", "syswrite", "bind", "getprotobyname", "readline", "tell", "binmode",
      "getprotobynumber", "readlink", "telldir", "bless", "getprotoent", "readpipe", "tie", "break",
      "getpwent", "recv", "tied", "caller", "getpwnam", "redo", "time", "chdir", "getpwuid", "ref",
      "times", "CHECK", "getservbyname", "rename", "truncate", "chmod", "getservbyport", "require",
      "uc", "chomp", "getservent", "reset", "ucfirst", "chop", "getsockname", "return", "umask",
      "chown", "getsockopt", "reverse", "undef", "chr", "glob", "rewinddir", "UNITCHECK", "chroot",
      "gmtime", "rindex", "unlink", "close", "goto", "rmdir", "unpack", "closedir", "grep", "say",
      "unshift", "connect", "hex", "scalar", "untie", "cos", "index", "seek", "use", "crypt",
      "INIT", "seekdir", "utime", "dbmclose", "int", "select", "values", "dbmopen", "ioctl",
      "semctl", "vec", "defined", "join", "semget", "wait", "delete", "keys", "semop", "waitpid",
      "DESTROY", "kill", "send", "wantarray", "die", "last", "setgrent", "warn", "dump", "lc",
  ...
  "builtinVariables" and listOf("\$!", "\$^RE_TRIE_MAXBUF", "\$LAST_REGEXP_CODE_RESULT", "\$"",
      ...
      "\$^WIDE_SYSTEM_CALLS", "\$OSNAME", "\$+", "\$^X", "\$OUTPUT_AUTO_FLUSH", "\$,", "\$_",
      "\$OUTPUT_FIELD_SEPARATOR", "\$-", "\$`", "\$OUTPUT_RECORD_SEPARATOR", "\$.", "\$a",
      ...
      "\$~", "\$^D", "\$EXTENDED_OS_ERROR", "%!", "\$^E", "\$FORMAT_FORMFEED", "%^H", "\$^ENCODING",
      "\$FORMAT_LINE_BREAK_CHARACTERS", "%ENV", "\$^F", "\$FORMAT_LINES_LEFT", "%INC", "\$^H",
      "\$FORMAT_LINES_PER_PAGE", "%OVERLOAD", "\$^I", "\$FORMAT_NAME", "%SIG", "\$^L",
      "\$FORMAT_PAGE_NUMBER", "@+", "\$^M", "\$FORMAT_TOP_NAME", "@-", "\$^N", "\$GID", "@_",
      "\$^O", "\$INPLACE_EDIT", "@ARGV", "\$^OPEN", "\$INPUT_LINE_NUMBER", "@INC", "\$^P",
