...
public val `Objective-cLanguage`: IMonarchLanguage = buildMonarchLanguage {
  ...
  keywords("#import", "#include", "#define", "#else", "#endif", "#if", "#ifdef", "#ifndef",
      ...
      "protected", "readwrite", "readonly", "register", "return", "SEL", "self", "short", "signed",
      "sizeof", "static", "struct", "super", "switch", "typedef", "TRUE", "true", "union",
